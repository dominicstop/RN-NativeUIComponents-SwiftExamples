...
public enum RCTModalViewError: String, CaseIterable {
  case modalAlreadyPresented        = "modalAlreadyPresented";
  case modalAlreadyDismissed        = "modalAlreadyDismissed";
  case modalDismissFailedNotInFocus = "modalDismissFailedNotInFocus";
